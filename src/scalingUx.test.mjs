...
assert.deepEqual(budgets.map((b) => b.preferredMin), [25, 25, 25, 25, 25, 25]);
assert.deepEqual(budgets.map((b) => b.preferredMax), [50, 50, 50, 50, 50, 50]);
assert.deepEqual(budgets.map((b) => b.hardMax), [60, 150, 300, 450, 600, 750]);
assert.deepEqual(budgets.map((b) => b.targetUrls), [60, 150, 300, 450, 600, 750]);
assert.deepEqual(budgets.map((b) => b.queryBudget), [12, 13, 25, 38, 50, 63]);
assert.deepEqual(budgets.map((b) => b.extractMax), [15, 38, 75, 113, 150, 150]);
