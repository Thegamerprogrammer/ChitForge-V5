...
assert.deepEqual(budgets.map((b) => b.preferredMin), [60, 60, 60, 60, 60, 60]);
assert.deepEqual(budgets.map((b) => b.preferredMax), [120, 120, 120, 120, 120, 120]);
assert.deepEqual(budgets.map((b) => b.softMax), [140, 140, 140, 140, 140, 140]);
assert.deepEqual(budgets.map((b) => b.hardMax), [160, 160, 160, 160, 160, 160]);
assert.deepEqual(budgets.map((b) => b.targetUrls), [60, 60, 80, 100, 130, 150]);
