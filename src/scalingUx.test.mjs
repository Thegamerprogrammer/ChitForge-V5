...
assert.deepEqual(budgets.map((b) => b.softMax), [60, 60, 60, 60, 60, 60]);
assert.deepEqual(budgets.map((b) => b.hardMax), [80, 80, 80, 80, 80, 80]);
assert.deepEqual(budgets.map((b) => b.targetUrls), [25, 25, 40, 50, 60, 80]);
